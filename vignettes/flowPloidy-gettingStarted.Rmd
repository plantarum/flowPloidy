...
We now have a usable result. Sadly for those of us working with
_Vaccinium_, we're usually limited to very low cell counts. But given the
challenges presented by this difficult tissue, we have succeeded in
isolating the nuclei necessary to get a GC estimate.
